...
public class ThriftNativeCodec implements Codec {
    ...
    protected void encodeRequest(Channel channel, OutputStream os, Request request)
        throws IOException {
    ...
    protected void encodeResponse(Channel channel, OutputStream os, Response response)
        throws IOException {
