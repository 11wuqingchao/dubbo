...
public class Tracer {
    ...
    private SyncTransfer syncTransfer = ExtensionLoader.getExtensionLoader(SyncTransfer.class)
            .getExtension(ConfigUtils.getProperty(TracingConstants.SYNC_TRANSFER_TYPE, TracingConstants.DEFAULT_SYNC_TRANSFER));
    ...
    public void addException(Throwable throwable) {
        ...
        if (span != null) {
            ...
            annotation.setKey(TracingConstants.EXCEPTION);
    ...
    private void setAttachment() {
        ...
        Span span = ContextHolder.getSpan();
        if (span != null) {
            rpcContext.setAttachment(TracingConstants.TRACING_SPAN_ID, span.getId());
            rpcContext.setAttachment(TracingConstants.TRACING_PARENT_SPAN_ID, span.getParentId());
        }
    }
